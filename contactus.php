...
$sendto = "anjanipolyclinic@gmail.com";
$subject = "New Enquiry";
//$message = 'Test message using PHP mail()';
$message_body= "Name of sender: $full_name  <br/> City: $city <br/> Mobile No: $mobile_no <br/> Email Address: $email  <br/> Message: $message";

if($email!="")
{
$header = "From:info@anjanipolyclinic.com"."\n";
}
else
{
	$header = "From:info@anjanipolyclinic.com"."\n";
...
$email_feed="anjanipolyclinic@gmail.com";
...
<title>Welcome to Anjani Paramedical Science Multispeciality Hospital</title>
